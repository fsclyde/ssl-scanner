...
@app.route('/reports/assets/application.css')
def application_css():
    scripts = [
...
@app.route('/reports/assets/images/<path:filename>')
def send_static_img(filename):
    directory = os.path.join('assets', 'images')
    return send_from_directory(directory, filename)

@app.route('/reports/views/<widget_name>.html')
